...
# 4. Update About.xml (using regex to preserve formatting and encoding without BOM)
...
$aboutText = $aboutText -replace '(?<=<modVersion[^>]*>).*?(?=</modVersion>)', $version
$utf8NoBom = New-Object System.Text.UTF8Encoding $false
[System.IO.File]::WriteAllText($aboutPath, $aboutText, $utf8NoBom)
...
# Extract the original annotated tag message generated by versionize
...
# Re-create the annotated tag using the preserved message
$tagMessage | git tag -f -a $tag -F -
